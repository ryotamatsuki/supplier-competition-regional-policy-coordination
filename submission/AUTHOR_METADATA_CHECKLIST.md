# IJIO Author Metadata / Editorial Manager Checklist

Complete these items from factual author information immediately before submission. Do not infer or auto-fill them from the manuscript.
...
## Ethics / declarations
- [ ] Competing interests: enter the author’s factual declaration
- [ ] Funding: enter actual funding source(s), grant number(s), or the journal’s no-funding response if factually correct
- [ ] Confirm all authors approve submission
- [ ] Confirm the manuscript is not simultaneously submitted elsewhere
- [ ] Enter preprint / working-paper information, if any
