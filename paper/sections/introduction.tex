...
Third, place-based and local-government policy can itself be understood through competition and rent allocation. \citet{Slattery2025} models state and local governments bidding for firms and shows that intergovernmental competition can transfer rents to firms. \citet{LinLi2026} study local industrial-policy competition in a quantitative spatial equilibrium environment. We instead study the reverse direction of strategic influence: competition among firms changes the equilibrium of a game among governments.
